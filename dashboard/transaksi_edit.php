                    ...
                    <form method="post" action="transaksi_update.php">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            while($p=mysqli_fetch_array($pakaian)){
                                ?>
                                <tr>
                                    <td><input type="text" autocomplete="off" class="form-control" name="jenis_pakaian[]" value="<?php echo $p['pakaian_jenis']; ?>"></td>
                            ...
                            <div class="form-group alert alert-info">
                                ...
                                <select class="form-control" name="status" required="required">
                                    ...
                                    <option <?php if($t['transaksi_status']=="1"){echo "selected='selected'";} ?> value="1">SELESAI</option>
                                </select>
                            </div>
                            <div class="form-group alert alert-info">
                                <label>Status Pembayaran</label>
                                <select class="form-control" name="status pembayaran" required="required">
                                    <option <?php if($t['transaksi_pembayaran']=="0"){echo "selected='selected'";} ?> value="0">BELUM LUNAS</option>
                                    <option <?php if($t['transaksi_pembayaran']=="1"){echo "selected='selected'";} ?> value="1">LUNAS</option>
